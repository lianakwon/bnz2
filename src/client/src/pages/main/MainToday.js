...
const MainToday = () => {
  ...
  const todays = [
    ...
    { id: 5, thum: "../../assets/icons/no_thum.png", title: "5 List<T> 컴파일 에러가 납니다. 도와주세요", cont: "List<T> 컴파일 에러가 납니다. 도와주세요 List<T> 컴파일 에러가 납니다. 도와주세요", author: "콩", isAnswered: false, quest: 5, heart: 6, cmmnt: 7 },
    { id: 6, thum: "../../assets/icons/no_thum.png", title: "6 List<T> 컴파일 에러가 납니다. 도와주세요", cont: "List<T> 컴파일 에러가 납니다. 도와주세요 List<T> 컴파일 에러가 납니다. 도와주세요", author: "콩", isAnswered: false, quest: 5, heart: 6, cmmnt: 7 }
  ];
